package com.shop.dealershop.helper;
...
public class Helper {
    ...
    public static class Error {
        ...
        public static boolean setViewAndIfHasErrRedirectAttr(ModelAndView modelAndView,
                                                             ...
                                                             String pathRedErr,
                                                             String pathRedNotErr) {
            if (result.hasErrors()) {
                attrs.forEach(redirectAttributes::addFlashAttribute);
                modelAndView.setView(new RedirectView(pathRedErr));
                return true;
            }

            if (!"".equals(pathRedNotErr)) {
                modelAndView.setView(new RedirectView(pathRedNotErr));
            }
